...
namespace ConsoleApp5
{
    ...
    class SOKOBAN
    {
        ...
        //
        // Programado por: Andrés Spalletta
        //
        // Consignas:
        ...
        public static Tile[,] CrearMapa(string[] infoMapa)
        {
            ...
            for (int f = 0; f < rv.GetLength(0); f++)
            {
                ...
                {
                    throw new ArgumentNullException("infoMapa es null");
                }
                ...
                for (int c = 0; c < rv.GetLength(1); c++)
                {
                    switch (infoMapa[f][c])
                    {
                        ...
                        case 'I':
                            ...
                            break;
                        default:
                            throw new ArgumentException("infoMapa tiene menos de 4 elementos");
                    }
            ...
            if (cantBotones > cantCajas || cantBotones < cantCajas || cantBotones == 0 || cantCajas == 0 || cantI == 0 || cantI > 1)
            {
                throw new FormatException(" infoMapa no tiene formato correcto");
            }
        ...
        public static bool[,] CrearCajas(Tile[,] mapa)
        {
            ...
            Tile[,] map;
            map = new Tile[mapa.Length, mapa.Length];

            rv = new bool[map.GetLength(0), map.GetLength(0)];
        ...
        public static bool EjecutarMovimiento(Direccion dir, Tile[,] mapa, bool[,] cajas, ref int filaJugador, ref int columnaJugador)
        {
            ...
            ActualizarMovimiento(dir, ref filaJugador, ref columnaJugador);
